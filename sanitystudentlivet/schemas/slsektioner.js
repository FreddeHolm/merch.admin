export default {
  ...
  fields: [
    ...
    },
    {
      ...
      title: 'Profile Image',
      type: 'array',
      description: 'Klistra in bildadress ovan eller ladda upp logga Optimerat för jpg, png och webp bilder',
...

    {
      ...
      of: [
        {
          type: 'reference',
          to: [{ type: 'sluniversities' }, { type: 'slkarhus' }, { type: 'slsektioner' }],
          options: {
            disableNew: true,
            filter: 'show == true',
          },
